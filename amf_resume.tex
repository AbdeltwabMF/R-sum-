...
\begin{itemize}[leftmargin=*]
  ...
  \begin{itemize}
    ...
    \projectSubItem{Tools: Python, Tkinter (GUI Programming).}
  \end{itemize}\vspace{-5pt}
  ...
  \begin{itemize}
    ...
    \projectSubItem{Tools: C++.}
  \end{itemize}\vspace{-5pt}

  \projectItem{\faIcon{mosque} \href{https://github.com/AbdeltwabMF/nxprayer}{Next Prayer}}{Sep. 2021 $-$ Present}
  \begin{itemize}
    \projectSubItem{Implementing a prayer reminder for Linux status bars.}
    \projectSubItem{Using config file for setting the location to make \emph{1 remote API / 6 years}.}
    \projectSubItem{Maintaining an AUR package for it.}
    \projectSubItem{Tools: C++, Bash, Python, Roff, Makefile.}
  \end{itemize}\vspace{-5pt}
\end{itemize}
...
\begin{itemize}[leftmargin=*]
  \techSkillItem{Programming Languages}{: C/C++, Python, Java (SE), SQL, \LaTeX{}, Bash/Shell.}
  \techSkillItem{Tools \& Technologies}{: GNU/Linux, Git, GNU Debugger, Emacs, Vim, SQLite.}
\end{itemize}
